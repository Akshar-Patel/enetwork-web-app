...
<% String search=request.getParameter("search");
   ...
   String sql="select user.uid,first_name,last_name,photo"
                     ...
                     + " and user.uid in("+session.getAttribute("friends")+")";
        ...
        <div class="search_col">
          ...
          if(friends!=null && friends!="")
            ...
            if(isfriend==true)
               {
                    %>
                    <span id="friend_status"><a class='link' id='friend_status' onclick='remove_friend(<%out.print(rs.getString("uid"));%>)'>Remove Friend</a></span>
                    <%
               }
            else if(rsfrq.getRow()!=0)
                {
           %>
                <span id="friend_status">Friend Request Sent.<br><a class='link' id='friend_status' onclick='cancel_friend_request(<%out.print(rs.getString("uid"));%>)'>Cancel Friend Request</a></span>
           <%
                }
                        else{
                %>
                <span style="" id="friend_status"><a class="link" id="friend_status" onclick="send_friend_request(<%out.print(rs.getString("uid"));%>)">Send Friend Request</a></span>
